		...
		<div class="container">
			<div class="row">
				<div class="col-xs-2 text-left">
					<div id="fh5co-logo"><a href="#">BUSHITHA<span>.</span></a></div>
				</div>
				...
				<div class="col-md-7 text-left">
					<div class="display-t">
						<div class="display-tc animate-box" data-animate-effect="fadeInUp">
							<h1 class="mb30">Inovative and Passionative</h1>
							<p>
								<a href="https://www.youtube.com/watch?v=SgsU8XdYSdU" class="link-watch popup-vimeo">Watch Video</a>
							</p>
						</div>
					</div>
				</div>
		...
		<div class="container">
			...
			<div class="row copyright">
				<div class="col-md-12 text-center">
					<p>
						<small class="block">&copy; 2016 BEST IT. All Rights Reserved.</small>
						<small class="block">Designed by <a href="https://lk.linkedin.com/in/emalsha-rasad" target="_blank">Emalsha</a></small>
					</p>
					<p>
